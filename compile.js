...
var fs = require('fs'),		// file system access
	...
	less = require('/usr/local/n/versions/node/8.2.1/lib/node_modules/less');	// less processor
...
var allFiles = [].concat(
		...
		fs.readdirSync("gridx").map(function(fname){ return "gridx/"+fname; }),
		fs.readdirSync("reels").map(function(fname){ return "reels/"+fname; }),
